...
export const auraDemoCatalog: AuraCatalog = {
  ...
  demoPolicies: {
    googleSignIn: "Google sign-in is simulated for demo purposes and does not connect to real Google accounts.",
    checkout: "Checkout is a demo flow only and does not process real payments or orders.",
    shipping: "Shipping guidance in this demo is informational only and does not reflect live fulfillment or delivery tracking.",
    favorites: "Favorites are saved only within the demo experience and may reset when the session ends.",
    account: "Account creation and sign-in are simulated for demo purposes and do not create real customer accounts.",
  },
};