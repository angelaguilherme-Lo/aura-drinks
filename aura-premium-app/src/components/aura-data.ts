...
export function getRelatedProducts(
  ...
  return products.filter(
    (product) =>
      product.collection === collection && product.slug !== currentSlug
  );
}
